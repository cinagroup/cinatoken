...
import (
	...
	"github.com/cinagroup/cinatoken/controller"
	...
	"github.com/cinagroup/cinatoken/relay"
	"github.com/cinagroup/cinatoken/router"
	"github.com/cinagroup/cinatoken/service"
	_ "github.com/cinagroup/cinatoken/setting/performance_setting"
...
func main() {
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/Calcium-Ion/cinatoken", err),
				"type":    "new_api_panic",
			},
		})
	}))
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami CINATOKEN-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics CINATOKEN-->\n")
	analyticsInject := analyticsInjectBuilder.String()
