...
import (
	...
	"github.com/cinagroup/cinatoken/relay/channel/ai360"
	"github.com/cinagroup/cinatoken/relay/channel/lingyiwanwu"

	//"github.com/cinagroup/cinatoken/relay/channel/minimax"
	"github.com/cinagroup/cinatoken/relay/channel/openrouter"
	"github.com/cinagroup/cinatoken/relay/channel/xinference"
	relaycommon "github.com/cinagroup/cinatoken/relay/common"
	"github.com/cinagroup/cinatoken/relay/common_handler"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "CINATOKEN")
		}
	}
	return nil
}
