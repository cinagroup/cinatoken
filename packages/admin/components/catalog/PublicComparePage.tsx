...
export default function PublicComparePage({ catalog }: { catalog: PublicCatalogResult }) {
	...
	const rows = [
		...
		{ key: 'zdr', value: (model: PublicCatalogModel) => model.dataPolicySummary.zdrAvailable ? '✓' : '—' },
