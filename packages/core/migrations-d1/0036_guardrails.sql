...
CREATE INDEX idx_guardrails_owner_status ON guardrails(owner_user_id, status, updated_at);
...
CREATE INDEX idx_guardrail_versions_guardrail_created ON guardrail_versions(guardrail_id, created_at);
