-- 0041: CinaToken-owned gateway workspaces over the CinaAuth organization projection.
...
CREATE TABLE workspaces (
  ...
  CONSTRAINT workspaces_default_key_chk CHECK (
    (is_default AND default_scope_key IS NOT NULL)
