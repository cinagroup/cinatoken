...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-cinatoken-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-cinatoken-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-cinatoken-container') return true;
      return (
