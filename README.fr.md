...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://docs.cinatoken.pro/en/docs/installation)
...
### 📖 [Documentation officielle](https://docs.cinatoken.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/cinagroup/cinatoken)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://docs.cinatoken.pro/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://docs.cinatoken.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://docs.cinatoken.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.cinatoken.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.cinatoken.pro/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://docs.cinatoken.pro/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- ⚡ [OpenAI Realtime API](https://docs.cinatoken.pro/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.newapi.pro/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://docs.cinatoken.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de relais](https://docs.cinatoken.pro/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/openai/createresponse) |
...
| 💬 Claude | Format Messages | [Documentation](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://docs.cinatoken.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://docs.cinatoken.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://docs.cinatoken.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://docs.cinatoken.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://docs.cinatoken.pro/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://docs.cinatoken.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://docs.cinatoken.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `cinagroup/cinatoken:latest`
...
📖 **Configuration complète:** [Documentation des variables d'environnement](https://docs.cinatoken.pro/en/docs/installation/config-maintenance/environment-variables)
...
2. Recherchez **CINATOKEN** dans le magasin d'applications
...
| 📘 FAQ | [FAQ](https://docs.cinatoken.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.cinatoken.pro/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://docs.cinatoken.pro/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://docs.cinatoken.pro/en/docs) |
...
**[Documentation officielle](https://docs.cinatoken.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/cinagroup/cinatoken/issues)** • **[Dernière version](https://github.com/cinagroup/cinatoken/releases)**
