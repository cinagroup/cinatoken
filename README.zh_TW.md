...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=cinatoken">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
📖 更多部署方式請參考 [部署指南](https://docs.cinatoken.pro/zh/docs/installation)
...
### 📖 [官方文件](https://docs.cinatoken.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/cinagroup/cinatoken)
...
| 分類 | 連結 |
|------|------|
| 🚀 部署指南 | [安裝文件](https://docs.cinatoken.pro/zh/docs/installation) |
| ⚙️ 環境配置 | [環境變數](https://docs.cinatoken.pro/zh/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文件 | [API 文件](https://docs.cinatoken.pro/zh/docs/api) |
| ❓ 常見問題 | [FAQ](https://docs.cinatoken.pro/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://docs.cinatoken.pro/zh/docs/support/community-interaction) |

---

## ✨ 主要特性

> 詳細特性請參考 [特性說明](https://docs.cinatoken.pro/zh/docs/guide/wiki/basic-concepts/features-introduction)
...
- 📱 Telegram 授權登錄
- 🔑 OIDC 統一認證
- 🔍 Key 查詢使用額度（配合 [neko-api-key-tool](https://github.com/cinagroup/neko-api-key-tool)）

### 🚀 高級功能

**API 格式支援：**
- ⚡ [OpenAI Responses](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.cinatoken.pro/zh/docs/api/ai-model/realtime/create-realtime-session)（含 Azure）
- ⚡ [Claude Messages](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.newapi.pro/api/google-gemini-chat)
- 🔄 [Rerank 模型](https://docs.cinatoken.pro/zh/docs/api/ai-model/rerank/create-rerank)（Cohere、Jina）
...
> 詳情請參考 [接口文件 - 中繼接口](https://docs.cinatoken.pro/zh/docs/api)

| 模型類型 | 說明 | 文件 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文件](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文件](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/openai/createresponse) |
...
| 🔄 Rerank | Cohere、Jina | [文件](https://docs.cinatoken.pro/zh/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文件](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文件](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
| 🎯 自訂 | 支援完整調用位址 | - |
...
- [聊天接口 (Chat Completions)](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/openai/createchatcompletion)
- [響應接口 (Responses)](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/openai/createresponse)
- [圖像接口 (Image)](https://docs.cinatoken.pro/zh/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音訊接口 (Audio)](https://docs.cinatoken.pro/zh/docs/api/ai-model/audio/openai/create-transcription)
- [影片接口 (Video)](https://docs.cinatoken.pro/zh/docs/api/ai-model/audio/openai/createspeech)
- [嵌入接口 (Embeddings)](https://docs.cinatoken.pro/zh/docs/api/ai-model/embeddings/createembedding)
- [重排序接口 (Rerank)](https://docs.cinatoken.pro/zh/docs/api/ai-model/rerank/creatererank)
- [即時對話 (Realtime)](https://docs.cinatoken.pro/zh/docs/api/ai-model/realtime/createrealtimesession)
- [Claude 聊天](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/createmessage)
- [Google Gemini 聊天](https://docs.cinatoken.pro/zh/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **最新版 Docker 鏡像：** `cinagroup/cinatoken:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `cinatoken` |
...
| `HOSTNAME` | Pyroscope 標籤裡的主機名                                          | `cinatoken` |

📖 **完整配置：** [環境變數文件](https://docs.cinatoken.pro/zh/docs/installation/config-maintenance/environment-variables)
...
| 項目 | 說明 |
|------|------|
| [neko-api-key-tool](https://github.com/cinagroup/neko-api-key-tool) | Key 額度查詢工具 |
| [cinatoken-horizon](https://github.com/cinagroup/cinatoken-horizon) | CINATOKEN 高性能優化版 |
...
| 📘 常見問題 | [FAQ](https://docs.cinatoken.pro/zh/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://docs.cinatoken.pro/zh/docs/support/community-interaction) |
| 🐛 回饋問題 | [問題回饋](https://docs.cinatoken.pro/zh/docs/support/feedback-issues) |
| 📚 完整文件 | [官方文件](https://docs.cinatoken.pro/zh/docs) |
...
**[官方文件](https://docs.cinatoken.pro/zh/docs)** • **[問題回饋](https://github.com/cinagroup/cinatoken/issues)** • **[最新發布](https://github.com/cinagroup/cinatoken/releases)**
